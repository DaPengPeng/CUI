...
//手势状态  999为特殊设打开图片就显示上下遮盖（999只走一次）， 0有上下黑色半透明遮盖   1，没有遮盖
...
#pragma mark - 上面都是get方法

//设置 图片对象
//aa类似于一个model对象，需要的参数都在这个model里
//array是model对象的数组
...
- (UIScrollView*) img_Scroll
{
    if(!_img_Scroll){
        ...
        [_img_Scroll setExclusiveTouch:YES]; //独有的
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (numOfPage != self.currentPage-1) {
        ...
        scro.zoomScale = 1;
        NSLog(@"还原之后%f",imgView.frame.size.width);
